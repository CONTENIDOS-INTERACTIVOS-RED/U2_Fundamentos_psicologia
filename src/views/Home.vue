        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La Unidad 2 aborda los procesos psicológicos básicos: percepción, atención, memoria, emoción, motivación y aprendizaje. Estos procesos son esenciales para comprender el comportamiento humano y su aplicación en la educación y salud mental. Se destaca la interdependencia entre ellos y su papel en el desarrollo cognitivo, emocional y social. Además, se analizan teorías psicológicas clásicas y actuales sobre la motivación y el aprendizaje, subrayando su importancia en el entorno educativo. El objetivo es el de promover una comprensión profunda que permita a los estudiantes aplicar estos conocimientos en contextos reales.
